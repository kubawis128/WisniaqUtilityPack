...
public class Renderer {
    ...
    public static void drawLine2(MatrixStack matrices,Camera cam, float x1, float y1, float z1, float x2, float y2 , float z2, Colors.ColorRGBA color) {
        ...
        matrixStack.push();
        matrixStack.translate(MinecraftClient.getInstance().getWindow().getScaledWidth() / 2, MinecraftClient.getInstance().getWindow().getScaledHeight() / 2, MinecraftClient.getInstance().inGameHud.getZOffset());
